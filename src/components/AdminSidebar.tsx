...
import { BarChart3, List, TrendingUp, Tag, Download, LogOut, X, Users } from 'lucide-react';
import { useAuth } from '../contexts/AuthContext';
import { motion, AnimatePresence } from 'motion/react';
import { getReports } from '../utils/mockData';
          ...
          {pendingCount > 0 && (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="font-bold text-slate-900 text-sm">Perhatian!</p>
              </div>
              <p className="text-xs text-slate-600">
                {pendingCount} laporan menunggu verifikasi Anda
              </p>
            </motion.div>
          )}
        </nav>
